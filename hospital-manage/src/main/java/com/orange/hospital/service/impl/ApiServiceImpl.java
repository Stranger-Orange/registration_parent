...
import com.orange.hospital.mapper.HospitalSetMapper;
...
import com.orange.hospital.util.BeanUtils;
import com.orange.hospital.util.HttpRequestHelper;
import com.orange.hospital.util.MD5;
...
public class ApiServiceImpl implements ApiService {
    ...
    public boolean saveHospital(String data) {
        ...
        if(null != respone && 200 == respone.getIntValue("code")) {
            ...
            throw new RegistrationException(respone.getString("message"), 201);
        }
    }
